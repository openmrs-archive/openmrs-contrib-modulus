...
//                             "rawFile:${userHome}/.grails/${appName}-config.properties",
//                             "rawFile:${userHome}/.grails/${appName}-config.groovy"]

// if (System.properties["${appName}.config.location"]) {
//    grails.config.locations << "rawFile:" + System.properties["${appName}.config.location"]
// }
